...
permutations = {
  ...
  u'hourly_traffic_count': PermuteEncoder(maxval=210, fieldName='hourly_traffic_count', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=210, classifierOnly=True, clipInput=True, minval=0, n=PermuteInt(28, 521), fieldname='hourly_traffic_count', w=21, type='ScalarEncoder', ),
      },
    },
