...
'/Library/Python/2.7/site-packages/nupic-0.1.0-py2.7.egg/nupic/frameworks/opf/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  u'hourly_traffic_count': PermuteEncoder(maxval=205, fieldName='hourly_traffic_count', w=21, clipInput=True, minval=0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=205, classifierOnly=True, clipInput=True, minval=0, n=PermuteInt(28, 521), fieldname='hourly_traffic_count', w=21, type='ScalarEncoder', ),
      },
    },
